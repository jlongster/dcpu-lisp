...
var VAL_dash_A = 8;
var VAL_dash_B = 9;
var VAL_dash_C = hex("0xa");
var VAL_dash_X = hex("0xb");
var VAL_dash_Y = hex("0xc");
var VAL_dash_Z = hex("0xd");
var VAL_dash_I = hex("0xe");
var VAL_dash_J = hex("0xf");
var NEXT_dash_VAL_dash_A = hex("0x10");
var NEXT_dash_VAL_dash_B = hex("0x11");
var NEXT_dash_VAL_dash_C = hex("0x12");
var NEXT_dash_VAL_dash_X = hex("0x13");
var NEXT_dash_VAL_dash_Y = hex("0x14");
var NEXT_dash_VAL_dash_Z = hex("0x15");
var NEXT_dash_VAL_dash_I = hex("0x16");
var NEXT_dash_VAL_dash_J = hex("0x17");
var POP = hex("0x18");
var PEEK = hex("0x19");
var PUSH = hex("0x1a");
var SP = hex("0x1b");
var PC = hex("0x1c");
var O = hex("0x1d");
var NEXT_dash_WORD = hex("0x1e");
var NEXT_dash_WORD_dash_VAL = hex("0x1f");
var emit = (function(s){
return println(s);
});
var hex = (function(v){
...
(function() {if(((exp > hex("0xffff")) || (exp < 0))) {throw(str("out of range:",exp));
} else {return false;
}})()
;
...
var HEAP = _emptylst;
var add_dash_to_dash_heap = (function(obj){
(function() {if(not(tagged_dash_object_p_(obj))) {throw(str("[add-to-heap] object not tagged: ",obj));
} else {return false;
}})()
;
HEAP = cons(obj,HEAP);
});
var tag_dash_object = (function(obj,type){
return vector("\uFDD1tagged",type,obj,false);
});
var tagged_dash_object_dash_type = (function(obj){
return obj["1"];
});
var tagged_dash_object_dash_obj = (function(obj){
return obj["2"];
});
var tagged_dash_object_dash_address = (function(obj){
return obj["3"];
});
var set_dash_tagged_dash_object_dash_address_excl_ = (function(obj,addr){
obj["3"] = addr;
});
var tagged_dash_object_p_ = (function(obj){
return _eq__eq_(obj["0"],"\uFDD1tagged");
});
var compile_dash_literal = (function(exp){
return ((function() {var o12 = (function(obj){
add_dash_to_dash_heap(obj);
return list(list("\uFDD1SET",A,obj));
});
var o13 = tag_dash_object(exp,type(exp));
return o12(o13);
}))();
});
var compile = (function(exp,insts){
return list_dash_append(insts,(function() {if(atom_p_(exp)) {return compile_dash_literal(exp);
} else {throw(str("unrecognized expression: ",exp));
}})()
);
});
var RAM = vector(65536);
var RAMPTR = 0;
var add_dash_to_dash_RAM = (function(word){
vector_dash_put_excl_(RAM,RAMPTR,word);
RAMPTR = (RAMPTR + 1);
});
var op = (function(code,a,b){
return (code & 0xf) |
         ((a & 0x3f) << 4) |
         ((b & 0x3f) << 10)});
var adv_dash_op = (function(code,a){
return ((code & 0x3f) << 4) |
         ((a & 0x3f) << 10)});
var emit_dash_SET = (function(inst){
return ((function() {var o14 = (function(target,obj){
return add_dash_to_dash_RAM(op(SET,target,0));
});
var o15 = cadr(inst);
var o16 = caddr(inst);
return o14(o15,o16);
...
var assemble = (function(exps){
return for_dash_each((function(inst){
return (function() {if(list_dash_find(list("\uFDD1SET"),car(inst))) {return ((function() {return emit_dash_SET(inst);
}))();
} else {return false;
}})()
;
...
assemble(compile(245,_emptylst));
((function() {var loop = (function(i){
return (function() {if((i < RAMPTR)) {return ((function() {pp(number_dash__gt_hex(vector_dash_ref(RAM,i)));
return vector("__tco_call",(function() {return loop((i + 1));
}));
}))();
} else {return false;
