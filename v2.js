...
return (number_p_(exp) || string_p_(exp) || boolean_p_(exp) || null_p_(exp) || symbol_p_(exp));
});
var hex = (function(v){
return parseInt(v,16);
});
var number_dash__gt_hex = (function(exp){
(function() {if(((exp > hex("ffff")) || (exp < 0))) {throw(str("out of range:",exp));
} else {return false;
}})()
;
return str("0x",exp["toString"](16));
});
var HEAP = vector(65536);
var HEAPPTR = 0;
var collapse_dash_bytes = (function(bytes){
return ((function() {var o12 = (function(vec){
return ((function() {var loop = (function(i){
return ((function() {var o15 = (function(idx){
return (function() {if(not((i < bytes["length"]))) {return vec;
} else {return ((function() {(function() {if(_eq__eq_((i % 2),0)) {return vector_dash_put_excl_(vec,idx,(vector_dash_ref(bytes,i) << 8));
} else {return vector_dash_put_excl_(vec,idx,(vector_dash_ref(bytes,i) | vector_dash_ref(vec,idx)));
}})()
;
return vector("__tco_call",(function() {return loop((i + 1));
}));
...
var o13 = vector(Math["round"]((bytes["length"] / 2)));
return o12(o13);
}))();
});
var transcode = (function(obj){
return (function() {if(number_p_(obj)) {return ((function() {(function() {if(((obj < 0) || (obj > hex("3fff")))) {throw(str("number out of range: ",obj));
} else {return false;
}})()
;
return vector(obj & 0x3fff);
}))();
} else {return (function() {if(string_p_(obj)) {return ((function() {return collapse_dash_bytes(vector_dash_concat(vector(hex("0x40")),vector_dash_concat(vector_dash_map((function(c){
return c["charCodeAt"]();
}),obj),vector(0))));
}))();
} else {return false;
...
var compute_dash_kind = (function(r,n){
return (local_dash_variable_p_(r,0,n) || global_dash_variable_p_(g_dash_current,n) || global_dash_variable_p_(g_dash_init,n));
});
var local_dash_variable_p_ = (function(r,i,n){
return (function() {if(null_p_(r)) {return false;
} else {return ((function() {var o17 = (function(res){
return (function() {if(res) {return list("\uFDD1local",i,(length(car(r)) - length(res)));
} else {return local_dash_variable_p_(cdr(r),(i + 1),n);
}})()
;
});
var o18 = list_dash_find(car(r),n);
return o17(o18);
}))();
}})()
;
});
var global_dash_variable_p_ = (function(g,n){
return ((function() {var o19 = (function(x){
return (x && cadr(car(x)));
});
var o20 = list_dash_find(g,n);
return o19(o20);
}))();
});
var r_dash_extend_star_ = (function(r,n_star_){
return cons(n_star_,r);
});
var r_dash_init = _emptylst;
var g_dash_current = _emptylst;
var g_dash_current_dash_extend_excl_ = (function(n){
return ((function() {var o21 = (function(level){
g_dash_current = cons(cons(n,list("\uFDD1global","\uFDD1.",level)),g_dash_current);
return level;
});
var o22 = length(g_dash_current);
return o21(o22);
}))();
});
var g_dash_init = _emptylst;
var g_dash_init_dash_extend_excl_ = (function(n){
return ((function() {var o23 = (function(level){
g_dash_init = cons(cons(n,list("\uFDD1predefined",level)),g_dash_init);
return level;
});
var o24 = length(g_dash_init);
return o23(o24);
}))();
});
var meaning_dash_quotation = (function(v,r,tail_p_){
return list("\uFDD1CONSTANT",v);
});
var meaning_dash_reference = (function(n,r,tail_p_){
return ((function() {var o25 = (function(kind){
return (function() {if(kind) {return (function() {if(list_dash_find(list("\uFDD1local"),car(kind))) {return ((function() {return ((function() {var o27 = (function(i,j){
return (function() {if(_eq__eq_(i,0)) {return list("\uFDD1SHALLOW-ARGUMENT-REF",j);
} else {return list("\uFDD1DEEP-ARGUMENT-REF",i,j);
}})()
;
});
var o28 = cadr(kind);
...
} else {return (function() {if(list_dash_find(list("\uFDD1global"),car(kind))) {return ((function() {return ((function() {var o30 = (function(i){
return list("\uFDD1CHECKED-GLOBAL-REF",i);
});
var o31 = cadr(kind);
return o30(o31);
}))();
}))();
} else {return (function() {if(list_dash_find(list("\uFDD1predefined"),car(kind))) {return ((function() {return ((function() {var o32 = (function(i){
return list("\uFDD1PREDEFINED",i);
});
var o33 = cadr(kind);
return o32(o33);
}))();
}))();
} else {return ((function() {throw(str("undefined variable: ",n));
}))();
}})()
;
}})()
...
var o26 = compute_dash_kind(r,n);
return o25(o26);
}))();
});
var meaning = (function(e,r,tail_p_){
return (function() {if(atom_p_(e)) {return (function() {if(symbol_p_(e)) {return meaning_dash_reference(e,r,tail_p_);
} else {return meaning_dash_quotation(e,r,tail_p_);
}})()
;
} else {return (function() {if(list_dash_find(list("\uFDD1quote"),car(e))) {return ((function() {return meaning_dash_quotation(cadr(e),r,tail_p_);
}))();
...
true;
((function() {var o39 = (function(res1,res2){
return (function() {if(not(_eq_(res1,res2))) {throw(str("assert failed: ",list("\uFDD1collapse-bytes",vector(list("\uFDD1hex","3"),list("\uFDD1hex","f4")))," got ",res1," but expected ",res2));
} else {return false;
}})()
;
});
var o40 = collapse_dash_bytes(vector(hex("3"),hex("f4")));
var o41 = vector(1012);
return o39(o40,o41);
}))();
((function() {var o42 = (function(res1,res2){
return (function() {if(not(_eq_(res1,res2))) {throw(str("assert failed: ",list("\uFDD1collapse-bytes",vector(list("\uFDD1hex","3"),list("\uFDD1hex","f4"),list("\uFDD1hex","4"),list("\uFDD1hex","3d")))," got ",res1," but expected ",res2));
} else {return false;
}})()
;
});
var o43 = collapse_dash_bytes(vector(hex("3"),hex("f4"),hex("4"),hex("3d")));
var o44 = vector(1012,1085);
return o42(o43,o44);
}))();
((function() {var o45 = (function(res1,res2){
return (function() {if(not(_eq_(res1,res2))) {throw(str("assert failed: ",list("\uFDD1transcode",3)," got ",res1," but expected ",res2));
} else {return false;
}})()
;
});
var o46 = transcode(3);
var o47 = vector(hex("3"));
return o45(o46,o47);
}))();
((function() {var o48 = (function(res1,res2){
return (function() {if(not(_eq_(res1,res2))) {throw(str("assert failed: ",list("\uFDD1transcode",16)," got ",res1," but expected ",res2));
} else {return false;
}})()
;
});
var o49 = transcode(16);
var o50 = vector(hex("10"));
return o48(o49,o50);
}))();
pp(meaning("\uFDD1foo",r["init"],true));
